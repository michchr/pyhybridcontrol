...
class MpcOptVariables(MpcBase):
    ...
    def gen_optimization_vars(self, N_p=None, N_p1=None, mld_numeric=None, mld_numeric_tilde=None,
        ...
        def app_tilde(var_name, postfix):
            return (
...
class MpcEvoGenerator(MpcBase):
    ...
    def gen_state_input_evolution_matrices(self, N_p=None, N_p1=None,
        ...
        state_input_evolution_struct['Phi_x_N_p1'] = Phi_x = self._gen_phi_x(**gen_kwargs)
        state_input_evolution_struct['Gamma_V_N_p1'] = Gamma_V = self._gen_gamma_V(**gen_kwargs)
        state_input_evolution_struct['Gamma_W_N_p1'] = Gamma_W = self._gen_gamma_W(**gen_kwargs)
        state_input_evolution_struct['Gamma_b5_N_p1'] = Gamma_b5 = self._gen_gamma_b5(**gen_kwargs)
    ...
    def _gen_A_pow_tilde(self, N_p=None, mld_numeric=None, mld_numeric_tilde=None, mld_info_k0=None,
    ...
    @process_method_args_decor(_process_base_args, _process_mat_op_args)
    def _gen_phi_x(self, N_p=None, mld_numeric=None, mld_numeric_tilde=None, mld_info_k0=None,

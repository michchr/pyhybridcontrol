...
from examples.residential_mg_with_pv_and_dewhs.modelling.parameters import dewh_param_struct

IDX = pd.IndexSlice

paths = glob.glob(r'./examples/sim_out/*')
...
#     os.path.realpath(r'./examples/data/dewh_omega_profile_df.pickle')) / dewh_param_struct.ts
#
# dewh = DewhAgentMpc()
...
# plot_omega(df_s)
# plot_omega2(df_s)
# df_p = plot_pv_resd(df_s)
# ax0 = plot_eg_water_demand_scenarios(20)
